...
const Card1 = ({ images = [], title = "Product Name" }) => {
  ...
  return (
    <div className="cardwrapper">
      <ToastContainer />
      <button className="card-button left9-btn" onClick={trendingPrevSlide}>
        <FaChevronLeft />
      </button>
      ...
      <button className="card-button right9-btn" onClick={trendingNextSlide}>
        <FaChevronRight />
      </button>
    </div>
  );
