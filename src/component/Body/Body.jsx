...
const images9 = [
  { url: "public/latest3.jpg.webp" },
  { url: "public/latest2.jpg.webp" },
  { url: "public/latest4.jpg.webp" },
  { url: "public/latest5.jpg.webp" },
  { url: "public/latest2.jpg.webp" },
  { url: "public/latest3.jpg.webp" },
  { url: "public/latest4.jpg.webp" },
  { url: "public/latest2.jpg.webp" },
...
const youLikeImages = [
  { url: "public/items1.jpg.webp" },
  { url: "public/items1.jpg.webp" },
  { url: "public/items2.jpg (1).webp" },
  { url: "public/latest2.jpg.webp" },
  { url: "public/latest4.jpg.webp" },
  { url: "public/latest3.jpg.webp" },
  { url: "public/latest4.jpg.webp" },
  ...
  <div className="carousel9-section">
      ...
      <div className="LatestNews">
       ...
       <div className="latestnewsimgandtext">
        <div className="Latestnewsimghlder">
          <img src="public/latest2.jpg.webp" alt="" className="latestnewsImage" />
        </div>
       ...
       <div className="latestnewsimgandtext">
        <div className="Latestnewsimghlder">
          <img src="public/latest3.jpg.webp" alt=""  className="latestnewsImage" />
        </div>
        <div className="latestNewsletter">
      ...
      <div className="Wrap1er">
         <div className="downicon">
            <div className="iconhld1"><PiTruckLight size={50}/></div>
            <h3>
            Fast & Free Delivery
            </h3>
            <p>
         ...
         <div className="downicon woman">
            <div className="iconhld1"><CiCreditCard1 size={50}/></div>
            <h3>
            Secure Payment
            </h3>
            <p>
         ...
         <div className="downicon man">
            <div className="iconhld1"><GiBank size={50} /></div>
            <h3>
         ...
         <div className="downicon">
            <div className="iconhld1"><TbClock24 size={50} /></div>
            <h3>
            Online Support
            </h3>
            <p>
